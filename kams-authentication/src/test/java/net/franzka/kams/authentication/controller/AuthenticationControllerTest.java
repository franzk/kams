...
class AuthenticationControllerTest {
    ...
    void authenticateTest() throws BadCredentialsException {
        ...
        AuthTokenDto authTokenDto = new AuthTokenDto(RandomString.make(64));
        ...
        // Act
        ResponseEntity<AuthTokenDto> result = controllerUnderTest.authenticate(testDto);
    ...
    void authenticateWithBadCredentialsExceptionTest() {
        ...
        // Act + Assert
        assertThrows(BadCredentialsException.class, () -> controllerUnderTest.authenticate(testDto));
    }
